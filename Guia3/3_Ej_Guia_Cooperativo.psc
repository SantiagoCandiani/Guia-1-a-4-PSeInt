...
SubAlgoritmo  calcularMuro
	...
	si espMuro=1 Entonces
		Escribir "Necesitará " CalS(alto , ancho)*10.9 " Kg de cemento"
		Escribir "Necesitará " CalS(alto , ancho)*0.09 " m3 de arena"
		Escribir "Necesitará " CalS(alto , ancho)*90 " ladrillos"
	FinSi
	
	si espMuro=2 Entonces
		Escribir "Necesitará " CalS(alto , ancho)*15.2 " Kg de cemento"
		Escribir "Necesitará " CalS(alto , ancho)*0.115 " m3 de arena"
		Escribir "Necesitará " CalS(alto , ancho)*120 " ladrillos"
	FinSi
